...
class XMLSecurityDSig
{
  ...
  <SignedInfo>
    ...
    public function validateDigest($refNode, $data)
    {
        ...
        $digValue = $this->calculateDigest($digestAlgorithm, $data, true);
    ...
    public function processTransforms($refNode, $objData, $includeCommentNodes = true)
    {
        ...
        if ($data instanceof DOMNode) {
            ...
            //$data = $this->str_replace_first("\n", "", $data); // I added this line
        }
        return $data;
    }
    ...
    private function addRefInternal($sinfoNode, $node, $algorithm, $arTransforms=null, $options=null)
    {
        ...
        $id_name = 'Id';
        $overwrite_id  = true;
        $force_uri = false; //Originalno je bilo false
    ...
    public function sign($objKey, $appendToNode = null)
    {
        ...
        if ($xpath = $this->getXPathObj()) {
            ...
            if ($sInfo = $nodeset->item(0)) {
                ...
                /*$sigValue = chunk_split($sigValue, 76, "\n");
                $sigValue = substr($sigValue, 0, -1);*/
    ...
    public static function staticAdd509Cert($parentRef, $cert, $isPEMFormat=true, $isURL=false, $xpath=null, $options=null)
    {
        ...
        foreach ($certs as $X509Cert) {
            ...
            // Added
            $x509IssuerNode = $baseDoc->createElementNS(self::XMLDSIGNS, $dsig_pfx.'X509SubjectName', "CN=AZVO/SPU,C=HR");
            $x509DataNode->appendChild($x509IssuerNode);
            //////////////////////////
            $X509 = str_replace(array("-----BEGIN CERTIFICATE-----\n", "-----END CERTIFICATE-----\n"), "", $X509Cert);
            $X509 = chunk_split($X509, 76, "\n");
            $X509 = substr($X509, 0, -1);
            $x509CertNode = $baseDoc->createElementNS(self::XMLDSIGNS, $dsig_pfx.'X509Certificate', $X509);
